    ...
    >
      <div className="flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Mobile Join Button */}
          <button className="lg:hidden bg-green-500 text-black px-3 py-1.5 rounded-md text-sm font-medium shadow">
            Join
          </button>
        </div>
        ...
        {/* Mobile Dropdown */}
        {isOpen && (
          <div className="absolute top-14 left-0 w-full bg-slate-200 shadow-lg rounded-md py-6 flex flex-col items-start gap-4 px-6 lg:hidden z-50">
