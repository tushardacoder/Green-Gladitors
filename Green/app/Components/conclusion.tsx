...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#CFE3C9] pt-16 pb-8 px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-75 px-4 py-3 rounded-lg bg-white/80 backdrop-blur border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
            />

            <button className="bg-green-500 hover:bg-lime-500 text-black font-semibold px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
              Reserve now
            </button>
          </div>
    ...
    {[
      ...
      <div
        key={index}
        className="bg-white px-4 py-2 rounded-md shadow-sm flex items-center justify-center"
      >
        <img
          src={item.src}
          alt={item.name}
        ...
        {/* Divider */}
        <div className="border-t border-gray-400/40 mt-10 pt-6 flex flex-col md:flex-row justify-between text-xs text-gray-700">
